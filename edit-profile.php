        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="images/foto2.jpg" class="edit-profile__avatar" />
                </div>
            ...
            <form action="" class="edit-profile__form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form__row">
                    <label for="nohp" class="form__label">Phone Number:</label>
                    <input id="phone" value="<?= $profile['nohp']; ?>" name=" nohp" type="number" class="form__input" />
                </div>
                <div class="form__row">
